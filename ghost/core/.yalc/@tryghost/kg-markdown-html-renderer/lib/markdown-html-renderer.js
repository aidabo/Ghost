...
const escapeHtmlAttribute = function (string = '') {
...
const mermaidFenceRenderer = function (md) {
    ...
    md.renderer.rules.fence = function (tokens, idx, options, env, self) {
        ...
        return `<div class="kg-card kg-mermaid-card" data-kg-card="mermaid" data-mermaid-source="${escapeHtmlAttribute(encoded)}"><div class="kg-mermaid-render"></div></div>`;
    };
};
